...
//!    known to fix it. The caller (`VpnServer::run`) closes the wedged
//!    endpoint, binds a fresh one with the same identity, and serves on again.
//!
...
//!
//! Ported from flextunnel's `transport::relay_watchdog`; keep the two in sync.
